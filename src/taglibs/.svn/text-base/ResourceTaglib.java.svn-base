...
public class ResourceTaglib implements Tag
{
  ...
  public int doEndTag() throws JspTagException
  {
   ...
   {        
     //pageContext.getOut().write(label+"&nbsp;&nbsp");
	   if (optional.equals("false")) pageContext.include("/forms/jsp/resource.jsp?label="+label+"&namespace="+namespace+"&property="+property+"&optional="+optional+"&ukda="+ukda+"&resourceNamespace="+resourceNamespace+"&resourceName="+resourceName); 
   }        
   catch(Exception e)       
   {           
