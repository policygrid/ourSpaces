...
public class KeywordsTaglib implements Tag
{
 ...
 private String optional = "";
  ...
  public int doEndTag() throws JspTagException
  {
   ...
   {        
     ...
     pageContext.include("/forms/jsp/keywords.jsp?label="+label+"&namespace="+namespace+"&property="+property+"&optional="+optional+"&ukda="+ukda); 
   }        
   catch(Exception e)       
   {           
