...
public class RDFTypeTaglib implements Tag
{
  ...
  public int doEndTag() throws JspTagException
  {
   ...
   {        
     //pageContext.getOut().write(label+"&nbsp;&nbsp");
	   pageContext.include("/forms/jsp/rdftype.jsp?label="+label+"&namespace="+namespace+"&property="+property); 
   }        
   catch(Exception e)       
   {           
