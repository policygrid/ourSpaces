...
var space = 'inettuts-<%=space%>-preferences';
...
var iNettuts = {
    ...
    init : function () {
        this.attachStylesheet('/ourspaces/inettuts.js.css');
        this.sortWidgets();
    ...
    initButtonsCollapse : function () {
    			$(".collapse").mousedown(function (e) {
                    /* STOP event bubbling */
                    e.stopPropagation();    
                }).click(function(){
                    $(this).parents(iNettuts.settings.widgetSelector).toggleClass('collapsed');
    ...
    addWidgetControls : function () {
        ...
        $(settings.widgetSelector, $(settings.columns)).each(function () {
            ...
            if (thisWidgetSettings.collapsible) {
                $('<a href="#" class="collapse">COLLAPSE</a>').prependTo($(settings.handleSelector,this));
            }
        });
