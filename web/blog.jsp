...
<script type="text/javascript" src="/ourspaces/javascript/pls.js"></script> 
 ...
 <div class="navBarLeft">
           <div class="dropdownBox">
              <a class="navBarLeft" href="#" style="float: left;"><img src="/ourspaces/images/spaces/Blogs_small.png" align="left" border="0"/><%=name%>'s Blog</a> <img src="/ourspaces/icons/dropdown.png" align="right" border="0"/>
             ...
             <ul id="column1" class="column" style="width: 660px;">
				...
				%> 
                   ...
                   <li class="widget color-white" id="<%=fields2[1] %>">
						...
						<a class="popup_comment_dialog" title="Comment" href="createcomment.jsp?namespace=<%=URLEncoder.encode(namespace) %>&about=<%=fields2[1] %>" style="color:#FF6600;">
