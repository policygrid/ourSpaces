...
<%
			...
			Vector otComres = user.getOthersResourcesByType(user.getID(),"http://www.policygrid.org/provenance-generic.owl#Communication",0,99999);
			myComres.addAll(otComres);
			for (int i=myComres.size()-1;i>=0;i--){
