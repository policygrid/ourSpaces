...
%><jsp:include page="header.jsp" flush="false">
		...
		<textarea rows="1" class="inputValue" style="width:250px; float: right; padding: 2px;  border: 1px solid #000000;" cols="45" id="<%=labelId %>value" name="<%=id %>" value="<%=value%>"></textarea>
