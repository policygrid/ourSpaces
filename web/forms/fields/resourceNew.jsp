...
<div id="<%=labelId %>inputDiv" class="resourceInputDiv">
	...
	<!-- <a href="" id="<%=labelId %>NewDiv" title="Create a new instance" style="background:url(/ourspaces/icons/001_01.png) no-repeat;float: left;height: 24px; width: 24px;"></a>-->
	<!-- 	<span class=" ui-icon ui-icon-zoomin" style="background-color: white; position: relative; top: 4px;display:inline-block;"></span> -->
		<input id="<%=labelId %>input" class="resourceInput" style=" border: 1px solid #000000;" id="<%=labelId %>" name="<%=id %>" size="60" type="text" value="<%=value%>">
