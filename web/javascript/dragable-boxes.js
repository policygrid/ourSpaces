	...
	*/	
	...
	function createColumns()
	{
		...
		for(var no=0;no<numberOfColumns;no++){
			...
			div.style.cssText = 'float:left;width:327px;padding:0px;margin:0px;';
	...
	function createABox(columnIndex,heightOfBox,externalUrl,uniqueIdentifier,notDragable)
	{
		...
		//var idArray[boxIndex] = new Array();
		//idArray[boxIndex] = new Array();
		//idArray[boxIndex]['uniqueIdentifier'] = uniqueIdentifier;
	...
	function createABox2(columnIndex,heightOfBox,externalUrl,uniqueIdentifier,notDragable, index)
	{
		boxIndex = index;
...
function createRSSBoxesFromCookie() 
   { 
	...
	{				
		...
		//var htmlContentOfNewBox = '<table border="0" cellspacing="0" cellpadding="0" width="290" style="margin-bottom:5px;"><tr><td align="right"><a href="#">Edit</a> | <a href="#">All Resources</a></td></tr></table><table border="0" cellspacing="3" cellpadding="3" width="290"><tr><td><div style="width:290px; margin-bottom:5px;"><span style="font-size:12px;"><a href="#">April Agenda</a></span></div> <div style="width:275px; margin-bottom:10px; padding-left:15px;"> [ <span style="color:#660000;">Deposited by</span> Richard Reid | <span style="color:#666000;">Authors:</span> Feikje Hielkema, Pete Edwards, Richard Reid ] - <a href="#">More</a></div><div style="width:290px; margin-bottom:5px;"><span style="font-size:12px;"><a href="#">questionnaire Feedback Form</a></span> </div> <div style="width:275px; margin-bottom:10px; padding-left:15px;"> [ <span style="color:#660000;">Deposited by</span> Richard Reid | <span style="color:#666000;">Authors:</span> Richard Reid ] - <a href="#">More</a></div><div style="width:290px; margin-bottom:5px;"><span style="font-size:12px;"><a href="#">APAT mid-term report</a></span> </div><div style="width:275px; margin-bottom:10px; padding-left:15px;"> [ <span style="color:#660000;">Deposited by</span> Richard Reid | <span style="color:#666000;">Authors:</span> Feikje Hielkema, Richard Reid, Pete Edwards ] - <a href="#">More</a></div> <div style="width:290px; margin-bottom:5px;"><span style="font-size:12px;"><a href="#">Semantic Grid Tools for Rural Policy Development and Appraisal</a></span> </div><div style="width:275px; margin-bottom:10px; padding-left:15px;"> [ <span style="color:#660000;">Deposited by</span> Richard Reid | <span style="color:#666000;">Authors:</span> Feikje Hielkema, Pete Edwards ] - <a href="#">More</a></div></td><tr></table>';	// HTML content of new box
		var htmlContentOfNewBox = '<table border="0" cellspacing="0" cellpadding="3" width="295" style="border:1px solid #CCCCCC;"><tr><td class="res2"></td><td align="right" style="padding-right:5px;"><a href="#">Upload</a> | <a href="#">All Resources</a></td></tr><tr><td class="res">&nbsp;</td></tr><tr><td class="res">20/07/08</td><td class="resInfo"><a href="#">April Agenda</a></td></tr><tr><td class="res">19/07/08</td><td class="resInfo"><a href="#">Semantic Grid Tools for Rural Policy Development and Appraisal</a></td></tr><tr><td class="res">12/07/08</td><td class="resInfo"><a href="#">APAT Mid-term Report</a></td></tr><tr><td class="res">10/07/08</td><td class="resInfo"><a href="#">Questionnaire Feedback Form</a></td></tr><tr><td class="res">04/07/08</td><td class="resInfo"><a href="#">A Flexible Interface to Community-Driven Metadata</a></td></tr><tr><td class="res">02/07/08</td><td class="resInfo"><a href="#">PolicyGrid Overview</a></td></tr><tr><td class="res">31/06/08</td><td class="resInfo"><a href="#">All Hands Abstract</a></td></tr><tr><td class="res3">&nbsp;</td></tr></table>';
		var titleOfNewBox = 'My Resources';
		...
		var htmlContentOfNewBox = '<table border="0" width="294" cellspacing="0" cellpadding="0"><tr><td><span style="font-size:18px;"><a class="tag" href="tagsearch.jsp?tag=Aberdeen">Aberdeen</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=Advisory group">Advisory group</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=Agenda">Agenda</a></span> <span style="font-size:15px;"><a class="tag" href="tagsearch.jsp?tag=APAT">APAT</a></span> <span style="font-size:15px;"><a class="tag" href="tagsearch.jsp?tag=computing student">cohesion</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=database">Evidence-based policy</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=development">dimension</a></span> <span style="font-size:15px;"><a class="tag" href="tagsearch.jsp?tag=ENT">environmental sustainability</a></span> <span style="font-size:15px;"><a class="tag" href="tagsearch.jsp?tag=JSP">isolation policy</a></span> <span style="font-size:23px;"><a class="tag" href="tagsearch.jsp?tag=machine learning">markers</a></span> <span style="font-size:15px;"><a class="tag" href="tagsearch.jsp?tag=meeting">meeting</a></span> <span style="font-size:18px;"><a class="tag" href="tagsearch.jsp?tag=model">model</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=ontology"></a></span> <span style="font-size:23px;"><a class="tag" href="tagsearch.jsp?tag=ourSpaces">Proceedings</a></span> <span style="font-size:15px;"><a class="tag" href="tagsearch.jsp?tag=point">Provenance</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=policy grid">PolicyGrid</a></span> <span style="font-size:15px;"><a class="tag" href="tagsearch.jsp?tag=profile">private transport</a></span> <span style="font-size:18px;"><a class="tag" href="tagsearch.jsp?tag=project">project collaboration</a></span> <span style="font-size:15px;"><a class="tag" href="tagsearch.jsp?tag=questionnaire">questionnaire</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=RDF">rural assessment</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=reasoning">reasoning</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=report">report</a></span> <span style="font-size:25px;"><a class="tag" href="tagsearch.jsp?tag=Richard">policy</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=rural">rural</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=services">services</a></span> <span style="font-size:15px;"><a class="tag" href="tagsearch.jsp?tag=Sesame">social review</a></span> <span style="font-size:18px;"><a class="tag" href="tagsearch.jsp?tag=settlements">settlements</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=student">Social Science</a></span> <span style="font-size:18px;"><a class="tag" href="tagsearch.jsp?tag=system">simulation</a></span> <span style="font-size:18px;"><a class="tag" href="tagsearch.jsp?tag=unversity">University of Aberdeen</a></span> <span style="font-size:12px;"><a class="tag" href="tagsearch.jsp?tag=vitual collaboration">virtual collaboration</a></span></<td></tr></table>';	// HTML content of new box
		var titleOfNewBox = 'My Tags';
		if(!staticObjectArray['staticObject5']){	// The box is not stored in cookie - we need to create it.
			var newIndex = createABox(1,false,false,'staticObject5');
			document.getElementById('dragableBoxContent' + newIndex).innerHTML = htmlContentOfNewBox;		
			document.getElementById('dragableBoxHeader_txt' + newIndex).innerHTML = titleOfNewBox;		
		}else{	// Box is stored in cookie - all we have to do is to move content into it.
		...
		var htmlContentOfNewBox = '<table width="290" border="0" style="margin-bottom:5px;"><tr><td align="right"><a href="#">Edit</a> | <a href="#">All Contacts</a></td></tr></table><table border="0" cellspacing="3" cellpadding="3" width="294"><tr><td><a href="#">Pete Edwards</a></td><td> [ <a href="#" target="page">Send a message</a> ] </td></tr><tr><td><a href="#">Feikje Hielkema</a></td><td> [ <a href="#" target="page">Send a message</a> ] </td></tr><tr><td><a href="#">Alison Chorley</a></td><td> [ <a href="#" target="page">Send a message</a> ] </td></tr><tr><td><a href="#">Edoardo Pignotti</a></td><td> [ <a href="#" target="page">Send a message</a> ] </td></tr><tr><td><a href="#">John Farrington</a></td><td> [ <a href="#" target="page">Send a message</a> ] </td></tr></table>';	// HTML content of new box
		var titleOfNewBox = 'My Contacts';
		if(!staticObjectArray['staticObject1']){	// The box is not stored in cookie - we need to create it.
			var newIndex = createABox(1,false,false,'staticObject1');
			document.getElementById('dragableBoxContent' + newIndex).innerHTML = htmlContentOfNewBox;		
			document.getElementById('dragableBoxHeader_txt' + newIndex).innerHTML = titleOfNewBox;		
		}else{	// Box is stored in cookie - all we have to do is to move content into it.
		...
		var htmlContentOfNewBox = '<table border="0" cellspacing="0" cellpadding="3" width="295" style="border:1px solid #CCCCCC;"><tr><td class="act2"></td><td align="right" style="padding-right:5px;"><a href="#">All Activities</a></td></tr><tr><td class="act">&nbsp;</td></tr><tr><td class="act">17/07/08</td><td class="actInfo">Feikje Hielkema has joined the PolicyGrid 2 project.</td></tr><tr><td class="act">16/07/08</td><td class="actInfo">Pete Edwards has joined the RELU project. </td></tr><tr><td class="act">12/07/08</td><td class="actInfo">Feikje Hielkema has uploaded a new resource.</td></tr><tr><td class="act">01/07/08</td><td class="actInfo">Pete Edwards has uploaded a new resource.</td></tr><tr><td class="act">01/07/08</td><td class="actInfo">Alison Chorley has joined the PolicyGrid project.</td></tr><tr><td class="act3">&nbsp;</td></tr></table>';	// HTML content of new box
		var titleOfNewBox = 'Our Activities';
		if(!staticObjectArray['staticObject6']){	// The box is not stored in cookie - we need to create it.
			var newIndex = createABox(3,false,false,'staticObject6');
			document.getElementById('dragableBoxContent' + newIndex).innerHTML = htmlContentOfNewBox;		
			document.getElementById('dragableBoxHeader_txt' + newIndex).innerHTML = titleOfNewBox;		
		}else{	// Box is stored in cookie - all we have to do is to move content into it.
		...
		var htmlContentOfNewBox = '<table border="0" width="290" cellspacing="0" cellpadding="0" style="padding-left:10px;"><tr><td align="right"><a href="#">Edit</a> | <a href="#">All Tools</a></td></tr><tr><td><ul><li><a href="#">LIBER</a></li><li><a href="#">SQUANTO</a></li><li><a href="#">EviCon</a></li><li><a href="#">SPSS</a></li><li><a href="#">FEARLUS</a></li></ul></td></tr></table>';	// HTML content of new box
		var titleOfNewBox = 'My Tools';
		if(!staticObjectArray['staticObject4']){	// The box is not stored in cookie - we need to create it.
			var newIndex = createABox(3,false,false,'staticObject4');
			document.getElementById('dragableBoxContent' + newIndex).innerHTML = htmlContentOfNewBox;		
			document.getElementById('dragableBoxHeader_txt' + newIndex).innerHTML = titleOfNewBox;		
		}else{	// Box is stored in cookie - all we have to do is to move content into it.
		...
		var htmlContentOfNewBox = '<table border="0" width="290" cellspacing="0" cellpadding="0" style="padding-left:10px;"><tr><td align="right"><a href="#">Edit</a> | <a href="#">All Projects</a></td></tr><tr><td><ul><li><a href="project.html">PolicyGrid</a></li><li><a href="#">PolicyGrid 2</a></li><li><a href="#">RELU</a></li></ul></td></tr></table>';	// HTML content of new box
		var titleOfNewBox = 'My Projects';
		if(!staticObjectArray['staticObject7']){	// The box is not stored in cookie - we need to create it.
			var newIndex = createABox(2,false,false,'staticObject7');
			document.getElementById('dragableBoxContent' + newIndex).innerHTML = htmlContentOfNewBox;		
			document.getElementById('dragableBoxHeader_txt' + newIndex).innerHTML = titleOfNewBox;		
		}else{	// Box is stored in cookie - all we have to do is to move content into it.
	...
	function createNewStaticBox(htmlContent, title, uniqueID)
	{
		var htmlContentOfNewBox = htmlContent;	// HTML content of new box
		var titleOfNewBox = title;
		if(!staticObjectArray[uniqueID]){	// The box is not stored in cookie - we need to create it.
			var newIndex = createABox(2,false,false,uniqueID);
			document.getElementById('dragableBoxContent' + newIndex).innerHTML = htmlContentOfNewBox;		
			document.getElementById('dragableBoxHeader_txt' + newIndex).innerHTML = titleOfNewBox;		
		}else{	// Box is stored in cookie - all we have to do is to move content into it.
			document.getElementById('dragableBoxContent' + staticObjectArray[uniqueID]).innerHTML = htmlContentOfNewBox;	
			document.getElementById('dragableBoxHeader_txt' + staticObjectArray[uniqueID]).innerHTML = titleOfNewBox;	
			
		}
		hideHeaderOptionsForStaticBoxes(staticObjectArray[uniqueID]);
	}
	
	function getNum(uniqueID){
		var i = 0;
		while (i <= boxIndex) {
			if(idArray[1]['uniqueIdentifier'] != 'staticObject1') {
				var newIndex = createABox(2,false,false,'test');
				document.getElementById('dragableBoxContent' + newIndex).innerHTML = i;		
				document.getElementById('dragableBoxHeader_txt' + newIndex).innerHTML = i;
	...
	function closeBox(uniqueID)
	{	
		var num = getNum(uniqueID);
		document.getElementById('dragableBox' + num).style.display='none';	
		
	}
	
	function closeSetBox(num)
	{	
		document.getElementById('dragableBox' + num).style.display='none';	
		
	}
	
	function openSetBox(num)
	{	
		document.getElementById('dragableBox' + num).style.display='';	
