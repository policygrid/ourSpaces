...
<div class="navBarLeft" style="z-index; -1;" >
       ...
       <div class="navBarLeft" style="z-index; -1;" >
           ...
           <a href="#" onClick ="showNewMessageDialog1();" ><img src="/ourspaces/icons/001_45.png" align="left" border="0"/>New Message</a>
            </div>
           <div class="separator">
              <img src="/ourspaces/icons/separator.png" align="right" style="margin: 0px;" border="0"/> 
           </div>          
...
$(document).ready(function(){
	...
	$('.loadmore').click(function(){
		...
		$.get('/ourspaces/commspaceLoader?action=inbox&user='+userid+'&start='+currentId,
			function (data){
			//alert(data);
				var json = eval('('+data+')');
				var lstmsg;
				...
				for (i=0;i<json.length;i++){
					...
					$("#msgpanel").append( "<div class='msgrow'  id="+json[i].id+"><span style='float:left;width:240px' class='msgsender'>"+json[i].sender+"</span><span class='msgsent' style='float:left;width:100px'>"+json[i].sentdate+"</span><br/><span style='float:left;width:300px;display:block;padding-top:5px;' class='msgsubject'>"+json[i].subject+"</span><span style='display:none;' class='otherrecs'>"+json[i].recipients+"</span><span class='otherrecids' style='display:none;'>"+json[i].otherrecids+"</span></div>");
...
<ul id="column2" class="column" style="width: 400px;">
 ...
 Vector messages = (Vector) user.getMessages(id,"messageid",0,0);
 if (messages.size() > 0) { 
 %>
...
<ul id="column1" class="column">
 					<li class="widget color-yellow " id="mail_message">
                       ...
                       <div id="newmessage">
                        ...
                        <div id="newmesgbody" class="ui-state-highlight ui-corner-all" style="margin:5px;padding:5px;width:555px;height:200px;min-height:200px;height:auto">
