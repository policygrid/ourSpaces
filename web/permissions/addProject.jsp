...
%>
			...
			<div style="position:relative; width:450px; float:left; padding-bottom:5px;" id="<%=memID%>con"> <!-- container -->
                ...
                <div style="position:relative; float:left; width:450px; margin-bottom:5px;" id="<%=memID%>search">
                    <input style="border:1px solid #006699; position:relative; float:left; padding-top:3px; width:300px; height: 17px;" onkeydown="return checkForm(event,'<%=memID%>','http://www.policygrid.org/project.owl','Project', <%=person %>);" onclick="clearValue('<%=memID%>in')" value="Search" type="text" id="<%=memID%>in" name="Keywords"/>
                    
                    
                    <div style="position:relative; float:left; width:25px; padding-top:2px; padding-left:10px;">
                        <a href="#" onClick="searchResource('<%=memID%>',document.getElementById('<%=memID%>in').value,'http://www.policygrid.org/project.owl','Project', '<%=person %>'); return false;"><img alt="" src="img/blue_search.gif" style="margin-right:5px; position:relative; float:left;"></a>
                    </div>
                    ...
                    <div style="position:relative; width:30px; display:none; float:left;" id="<%=memID%>gah">
                        ...
                        <input type="hidden" id="<%=memID%>r" name="project"/>
                    </div>
