...
<div  style="float:left; width: 100%; height: 100%;" id="provenance<%=escId%>">
	...
	<div class="controls" style="background-color: #222222;float: left; width: 100%;">
							...
							<a class="timestampLayout" style="float:left" title="Layout according to time" href="#" onclick="provVis<%=escId.replaceAll("-","")%>.layout.layout();return false;"><img src="/ourspaces/icons/001_60.png" style="border:0;margin:5px;"></img></a>
							<a class="springLayout" style="float:left" title="Dynamic layout" href="#" onclick="provVis<%=escId.replaceAll("-","")%>.layout.layoutSpring();provVis<%=escId.replaceAll("-","")%>.layout.resize();return false;"><img src="/ourspaces/icons/001_61.png" style="border:0;margin:5px;"></img></a>
							<a class="hideShow" style="float:left" title="Hide/Show selected nodes" href="#" onclick="provVis<%=escId.replaceAll("-","")%>.graph.switchVisibility();if($(this).children('img').attr('src')=='/ourspaces/icons/001_04.png') {$(this).children('img').attr('src','/ourspaces/icons/001_03.png');return false;} else {$(this).children('img').attr('src','/ourspaces/icons/001_04.png');return false;}"><img src="/ourspaces/icons/001_04.png" style="border:0;margin:5px;"></img></a>
						</div>
</div>
